...
WORDLIST_FILENAME = "C:\Users\Ramenga\Documents\Py\words_ps4.txt"
...
def getWordScore(word, n):
    ...
    score = 0
    for letter in word:
        summation += SCRABBLE_LETTER_VALUES[letter]
    if len(word)==n:
        score = (summation*len(word))+50
    else:
        score = summation*len(word)
...
def playGame(wordList):
    ...
    while response != 'e':
        ...
        elif response=='r' and len(hand)==0:
